...
<meta charset="utf-8"/>
<title>Nancy Wang | Let's Hear It</title>
...
<div id="header-interview">
  ...
  <p id="interview-description">
    On leading product teams at Google, Rubrik, and AWS and her passion for advancing women in technology and venture capital.
  </p>
</div>
...
<div id="q-wrap">
  ...
  <div id="qs">
    <p id="first"> <a href="#1">Tell me a little bit about yourself. Where did you go to school and what did you study? </a></p>
    <p> <a href="#2">How did you make the switch from working in the government to product management? </a></p>
    <p> <a href="#3">You were the first female product manager at Google Fiber between 2014 and 2016. What was it like?  </a></p>
    <p> <a href="#4">Did you feel that you were part of a community of women? </a></p>
    <p> <a href="#5">How did this change your perspective on women in tech since you were at UPenn?</a></p>
    <p> <a href="#6">After Google, you joined Rubrik as the first female product manager. Was it similar to your experience being a female PM at Google?</a></p>
    <p> <a href="#7"> When you were doing work in venture capital, what were some things you noticed while working with startups?</a></p>
    <p> <a href="#8">You stated recently in Forbes “tech entrepreneurs are focused on building the right product. But as more data is analyzed, there is another factor that drives startup success or failure rates — company culture and leadership diversity.” How evident do you think this is to startup founders today?</a></p>
    <p><a href="#9"> How do you think diversity in venture capital is changing for women? </a></p>
    <p><a href="#10">As for your work in getting more women in tech leadership roles, what motivated you to start Advancing Women in Product?</a></p>
    <p><a href="#11">What are your goals and plans for Advancing Women in Product? </a></p>
    <p><a href="#12">Is there anything else you’d like to add as well as any advice you'd give to aspiring product managers? </a></p>
  </div>
  ...
  <div id="photo-wrap">
    <div id="interview1">
      <a href="kara-interview.php">
        <img alt="kara goldin" src = "images/kara-preview.png" width="390"/>
        </a>
    </div>

    <div id="interview2">
      <a href="https://medium.com/lets-hear-it/hearherstory-aanchal-gupta-68a4f61a4816?source=collection_category---3------3---------------------">
        <img alt="yari blanco" src = "images/aanchal-preview.png" width="390"/>
    </a>
    </div>

    <div id="interview3">
    <a href="https://medium.com/lets-hear-it/hearherstory-geneva-peschka-b1bad5940377?source=collection_category---3------4---------------------">
      <img alt="yari blanco" src = "images/geneva-preview.png" width="390"/>
    </a>
    </div>
  </div>
