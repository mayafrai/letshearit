...
<meta charset="utf-8"/>
<title>Cheryl Yeoh | Let's Hear It</title>
...
<div id="bio-wrap">
  <div id="bio-img">
      <img alt="yari blanco" src = "images/cheryl-bio.jpg" width="550"/>
      <p id="img-cred"> Photo: Cheryl Yeoh </p>
  </div>

  <div id="bio-content">
    <p id="bio-p">Cheryl Sew Hoy is currently an EIR at SVB, Advisor to Cosmos/Tendermint, Culture Summit, and many other startups, and Board Member of Flexiroam LTD, and currently resides in the San Francisco Bay Area. <br/><br/>She was listed in TIME’S “2017 Person of the Year,” as the 13th “Silence Breaker,” who spoke out against sexual harassment in the workplace. <br/><br/>On March 8, 2018, she launched #MovingForward, which is an open-source directory to highlight VC’s anti-discrimination and anti-harassment policies and reporting contacts. As of Sept 2018, 110+ VC firms have committed as full participants.</p>
  </div>
</div>
...
<div id="footer-interview">
  ...
  <div id="photo-wrap">
    <div id="interview1">
      <a href="https://medium.com/lets-hear-it/hearherstory-yari-blanco-4404b94c032a?source=collection_category---3------5---------------------">
        <img alt="yari blanco" src = "images/yari-preview.png" width="390"/>
        </a>
    </div>
